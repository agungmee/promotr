          ...
          <div class="table-responsive">
            ...
            <?php $__currentLoopData = $dataPromoPhilips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $led2021): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                ...
                <td>
                <div class="input-group-btn">
                  <a href="#"><i class="fas fa-edit"></i></a> | <a href=" philips/delete/<?php echo e($led2021->id); ?>" onclick="return confirm('Yakin Mau Hapus?');"><i class="fas fa-trash" style="color: red;"></i></a>
                </div>
                </td>
              </tr>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/promotr2/resources/views/pages/promo/2021/test.blade.php ENDPATH**/ ?>